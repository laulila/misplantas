...
def mostrar_productos(request):
    ...
    return render(request, 'App5/productos.html', context=context)
...
def mostrar_usuarios(request):
    ...
    return render(request, 'App5/usuarios.html', context=context)
...
def mostrar_ventas_detalles(request):
    ...
    return render(request, 'App5/ventas_detalles.html', context=context)
...
def crear_Usuarios(request):
    ...
    return render(request, 'App5/crear_usuarios.html', {'form': crear_Usuarios_forms})
...
def crear_Productos(request):
    ...
    return render(request, 'App5/crear_productos.html', {'form': crear_Productos_forms})
...
def crear_Ventas_detalles(request):
    ...
    return render(request, 'App5/crear_ventas.html', {'form':crear_Ventas_detalles_forms})
...
def buscar_marca_producto(request):
    ...
    return render(request, 'App5/buscar_marca_producto.html',{'respuesta': respuesta})
...
def buscar_usuario(request):
    ...
    if request.GET.get('email_usuario', False):
        ...
        return render(request, 'App5/buscar_usuarios.html', {'usuario': usuario})
    else:
        respuesta = 'No hay datos'
    return render(request, 'App5/buscar_usuarios.html', {'respuesta': respuesta})
...
def buscar_forma_de_pago(request):
    ...
    if request.GET.get('forma_de_pago', False):
        ...
        return render(request, 'App5/buscar_ventas_detalles.html', {'ventas_detalles': ventas_detalles})
    else:
        respuesta = 'No hay datos'
    return render (request, 'App5/buscar_ventas_detalles.html', {'respuesta': respuesta})
...
def eliminar_productos(request, productos_id):
    ...
    return render(request, 'App5/index.html', context=context)
...
def actualizar_usuarios(request, usuario_id):
    ...
    return render(request, 'App5/actualizar_usuarios.html', {'form': crear_Usuarios_forms})
...
def registro_usuario(request):
    ...
    return render(request, 'App5/registro.html', {'form': form})
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if user is not None:
                ...
                return render(request,"App5/index.html",{"mensaje":f"Bienvenido {usuario}"})
            else:
            
                return render (request,"App5/index.html",{"mensaje":"Error, datos incorrectos"})
        else:
           
                return render(request, "App5/index.html", {"mensaje":"Error,formulario erroneo"})
...
def logout_request(request):
    logout(request)
    return render(request, "App5/index.html", {"mensaje":"Has cerrado sesión exitosamente."})
    
def privacy_policy(request):
     return render(request, "App5/privacy_policy.html")

def terms_conditions(request):
     return render(request, "App5/terms_conditions.html")
...
def contacto(request):
     if request.method == 'POST':
         ...
         template = render_to_string('App5/email-template.html',{
             'nombre': nombre,
             'email': email,
             'mensaje': mensaje,
             'asunto': asunto,
     ...
     return render(request, 'App5/contacto.html')
 
def pagina_de_gracias(request):
    return render(request, 'App5/gracias.html')
...
def listar_mensajes(request):
    ...
    return render(request, 'App5/lista_mensajes.html', {'page_obj': page_obj})
